...
- **LLM_MODEL_ROUTER** — Model for Intent Classification (def: `nvidia/nemotron-3-nano-30b-a3b`)
- **LLM_MODEL_GENERAL** — Model for General Agent (def: `google/gemini-3-flash-preview-20251217`)
