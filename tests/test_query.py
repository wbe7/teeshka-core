...
class TestQueryEndpoint:
    ...
    def test_query_returns_echo(self) -> None:
    ...
    def test_query_returns_trace_id(self) -> None:
    ...
    def test_query_in_openapi(self) -> None:
    ...
    def test_query_response_version(self) -> None:
